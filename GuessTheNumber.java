...
public class GuessTheNumber {
    public static void main(String[] args) {
        ...
        System.out.println(
                "I have selected a random number between " + lowerBound + " and " + upperBound + ". Can you guess it?");
            ...
            while (!hasGuessedCorrectly && attempts < 5) { // Allowing a maximum of 5 attempts per round
                ...
                if (guess < lowerBound || guess > upperBound) {
                    ...
                    System.out.println("Congratulations! You've guessed the number in " + attempts
                            + " attempts. You scored " + roundScore + " points in this round.");
                }
            }
        ...
        System.out.println(
                "Game Over! You took " + totalAttempts + " attempts in total and scored " + totalScore + " points.");
        scanner.close();
    }
}
